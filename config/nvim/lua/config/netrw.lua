...
vim.api.nvim_create_autocmd("FileType", {
  ...
  callback = function()
    ...
    vim.keymap.set("n", "<c-v>", open_in_vsplit, { buffer = true, silent = true })
    vim.keymap.set("n", "<c-s>", open_in_split, { buffer = true, silent = true })
  end,
})
...
vim.keymap.set("n", "<leader>e", function()
  ...
  vim.cmd("Lexplore " .. vim.fn.fnameescape(vim.fn.fnamemodify(vim.fn.expand("%:p"), ":h")))
end, { silent = true })
